...
arm-none-eabi-gcc %FILENAME% -Xlinker --start-group ../%LPC_PATH%/Debug/liblpcopen_lpc4337.a -Xlinker --end-group -o ../bin/%NOMBRE%.axf -fno-builtin -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=softfp -mthumb -Wl,-Map="../bin/%NOMBRE%.map",-gc-sections -nostdlib -T "../ld/ciaa_lpc4337.ld" 
...
copy NUL bin\.gitkeep
copy NUL obj\.gitkeep

echo,
echo - Generacion de archivos gitkeep: OK
echo,
